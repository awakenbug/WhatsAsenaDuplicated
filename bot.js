        ...
        if (config.WORKTYPE == 'public') {
            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                ...
                if (conn.user.jid === '994775035797@s.whatsapp.net' || conn.user.jid === '37254693326@s.whatsapp.net' || conn.user.jid === '905423036554@s.whatsapp.net' || conn.user.jid === '905396978235@s.whatsapp.net' || conn.user.jid === '905452641686@s.whatsapp.net' || conn.user.jid === '905550858656@s.whatsapp.net') {
                    ...
                    await conn.sendMessage(conn.user.jid, '*4LPH4_CR4CKZ Working as Public! 🐺*\n\n_Please do not try plugins here. This is your LOG number._\n_You can try commands to any chat :)_\n\n*Your bot working as public. To change it, make the “WORK_TYPE” switch “private” in config vars.*\n\n*Thanks for using 4LPH4_CR4CKZ 💌*', MessageType.text);
                    ...
                    if (sendMsg) {
                        ...
                        try {
                            ...
                            if (error.message.includes('429')) return;
                                ...
                                await conn.sendMessage(conn.user.jid, '*-- HATA RAPORU [4LPH4_CR4CKZ] --*' + 
                                    '\n*4LPH4_CR4CKZ bir hata gerçekleşti!*'+
                                ...
                                if (error.message.includes('URL')) {
                                    return await conn.sendMessage(conn.user.jid, '*⚕️ HATA ÇÖZÜMLEME [4LPH4_CR4CKZ] ⚕️*' + 
                                        '\n========== ```Hata Okundu!``` ==========' +
                                    ...
                                    return await conn.sendMessage(conn.user.jid, '*⚕️ HATA ÇÖZÜMLEME [4LPH4_CR4CKZ] ⚕️*' + 
                                        ...
                                        '\n*Çözümü:* _https://github.com/phaticusthiccy/4LPH4_CR4CKZDuplicated/wiki/LYDIA-API-KEY \nBu adrese gidip lütfen Lydia için API anahtarı ayarlayın._'
                                        , MessageType.text
                                    );
                                }
                                ...
                                await conn.sendMessage(conn.user.jid, '*-- ERROR REPORT [4LPH4_CR4CKZ] --*' + 
                                    '\n*4LPH4_CR4CKZ an error has occurred!*'+
                                ...
                                if (error.message.includes('URL')) {
                                    return await conn.sendMessage(conn.user.jid, '*⚕️ ERROR ANALYSIS [4LPH4_CR4CKZ] ⚕️*' + 
                                        '\n========== ```Error Resolved!``` ==========' +
